                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form id="formAccountSettings" method="POST"
                                    action="{{ route('profile.image.update') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        @if ($user->profile_image_path)
                                            <img src="{{ Storage::url($user->profile_image_path) }}" alt="user-avatar"
                                                class="d-block rounded" height="120" width="120" />
                                        @else
                                            <img src="/images/profile-default.png" alt="default-avatar"
                                                class="d-block rounded" height="120" width="120"
                                                id="defaultAvatar" />
                                        ...
                                        <div class="button-wrapper">
                                            <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                                <span class="d-sm-block">Select Image</span>
                                                ...
                                                <input type="file" id="upload" name="profile_image"
                                                    ...
                                                    style="display: none" onchange="displayFileName(event)"
                                                    id="uploadFoto" />
                                            </label>
                                            <button type="submit"
